...
import bin.rss.RssParser as mparser
...
class M2em:
    ...
    def read_arguments(self):
        ...
        parser.add_argument("-s", "--start", help="Starts one loop",
                            action="store_true")
        parser.add_argument('-id', '--ignore-date', help="ignore 24h capter date",
                            action="store_true")
        ...
        parser.add_argument("-rss-d", "--duplicates",
                            help="Break rss process when x duplicates are found ",
                            default=-1)
    ...
    def start_action(self):
        ...
        # Start downloader
        elif self.args.action == "downloader":
            ...
            logging.info("%s is not a valid action. Choose between  'rssparser', 'downloader', 'converter' or 'sender'",
                         self.args.action)
